...
$servidor = "localhost:3307"; $usuario = "root"; $contrasenia = ""; $nombreBaseDatos = "empleados";
...
if(isset($_GET["insertar"])){
    ...
    $correo=$data->correo;
        if(($correo!="")&&($nombre!="")&&($id!="")){
            $sqlEmpleaados = mysqli_query($conexionBD,"INSERT INTO empleados(id,nombre,correo) VALUES('$id','$nombre','$correo') ");
            echo json_encode(["success"=>1]);
        }
    exit();
}
